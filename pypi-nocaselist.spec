...
%prep
%setup -q -n nocaselist-1.0.5
cd %{_builddir}/nocaselist-1.0.5
pushd ..
cp -a nocaselist-1.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653346828
...
cp %{_builddir}/nocaselist-1.0.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nocaselist/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
