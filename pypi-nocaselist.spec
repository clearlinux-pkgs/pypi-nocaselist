...
Source0  : https://files.pythonhosted.org/packages/cf/2e/4e7381b5552f530fa60f604a47bec08fe285bd3a4ee800cccdccfd978fa4/nocaselist-2.0.3.tar.gz
...
%prep
%setup -q -n nocaselist-2.0.3
cd %{_builddir}/nocaselist-2.0.3
pushd ..
cp -a nocaselist-2.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723988315
